function [dist,diff_dist]=user_defined_initial_dist(domain,location,concentration,omega,i,dt)
...
%     diff_dist=(-concentration*sin(domain-location-omega*i*dt).*exp(concentration*cos(domain-location-omega*i*dt)))/(2*pi*besseli(0,concentration));
    ...
    %Fixed_initial_distribution_Comment
%SPECIFIED_INITIAL_DISTRIBUTION
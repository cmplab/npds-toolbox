...
%%%  FOR SOLVING THE DE-COUPLED MODEL FOR A POPULATION OF NEURONS WITHOUT WHITE NOISE
...
function [phi,L2,thetas,u,sim_time,domain]=decoupled_RBFFD(handles,M,flag)
...
for i=1:S
    ...
    thetas(i+1,:)=RK4control(thetas(i,:),u(i+1),T,dt,model,'RBFFD');

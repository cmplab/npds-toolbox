%%% THE RADIAL BASIS FUNCTION METHOD  FOR SOLVING THE DE-COUPLED MODEL FOR A POPULATION OF NEURONS WITH WHITE NOISE
...
function [phi,L2,thetas,u,sim_time,domain]=noisy_decoupled_RBF(handles,M,flag)
